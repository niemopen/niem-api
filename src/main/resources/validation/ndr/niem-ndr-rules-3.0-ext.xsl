...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
  ...
  <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M100">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
  ...
  <!--RULE -->
   <xsl:template match="*[exists(@appinfo:deprecated)]" priority="1000" mode="M116">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
  ...
  <!--RULE -->
   <xsl:template match="term:LocalTerm" priority="1000" mode="M120">
  ...
  <!--RULE -->
   <xsl:template match="term:LocalTerm" priority="1000" mode="M121">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="term:LocalTerm"/>
    <!--ASSERT -->
      <xsl:choose>
  ...
  <!--RULE -->
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M124">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@base)]"/>
    <!--ASSERT -->
      <xsl:choose>
  ...
  <!--RULE -->
   <xsl:template match="xs:simpleType[@name]" priority="1000" mode="M125">
  ...
  <!--RULE -->
   <xsl:template match="xs:simpleType[exists(@name)]" priority="1000" mode="M126">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
  ...
  <!--RULE -->
   <xsl:template match="xs:list[exists(@itemType)]" priority="1000" mode="M127">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
  ...
  <!--RULE -->
   <xsl:template match="xs:union[exists(@memberTypes)]" priority="1000" mode="M128">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
  ...
  <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M132">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:element[exists(@name)]"/>
    <!--ASSERT -->
      <xsl:choose>
  ...
  <!--RULE -->
   <xsl:template match="xs:import" priority="1000" mode="M148">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:import"/>
