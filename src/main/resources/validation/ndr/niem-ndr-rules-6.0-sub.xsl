...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Rules for subset XML Schema documents"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule_4-9</xsl:attribute>
            <xsl:attribute name="name">Schema claims subset conformance target</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Rules for subset XML Schema documents</svrl:text>
   ...
   <!--PATTERN rule_4-9Schema claims subset conformance target-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schema claims subset conformance target</svrl:text>
   <!--RULE -->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 4-9: The document MUST have an effective conformance target identifier of https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#SubsetSchemaDocument.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M10"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-42: 
     An element type that is not xs:anySimpleType MUST NOT be a simple type.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M44"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M45">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M46">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:notation" priority="1000" mode="M54">
   ...
   <!--RULE -->
   <xsl:template match="xs:all" priority="1000" mode="M55">
   ...
   <!--RULE -->
   <xsl:template match="xs:sequence" priority="1000" mode="M58">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:sequence"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:unique" priority="1000" mode="M62">
   ...
   <!--RULE -->
   <xsl:template match="xs:key" priority="1000" mode="M63">
   ...
   <!--RULE -->
   <xsl:template match="xs:keyref" priority="1000" mode="M64">
   ...
   <!--RULE -->
   <xsl:template match="xs:group" priority="1000" mode="M65">
   ...
   <!--RULE -->
   <xsl:template match="xs:attributeGroup[@name]" priority="1000" mode="M66">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="node()[comment()]" priority="1000" mode="M67">
   ...
   <!--RULE -->
   <xsl:template match="xs:documentation/node()" priority="1000" mode="M68">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="xs:appinfo/node()" priority="1000" mode="M69">
   ...
   <!--RULE -->
   <xsl:template match="xs:appinfo/*" priority="1000" mode="M70">
   ...
   <!--RULE -->
   <xsl:template match="xs:appinfo//xs:*" priority="1000" mode="M71">
   ...
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M72">
   ...
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M73">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M74">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:redefine" priority="1000" mode="M75">
   ...
   <!--RULE -->
   <xsl:template match="xs:include" priority="1000" mode="M76">
   ...
   <!--RULE -->
   <xsl:template match="xs:import" priority="1000" mode="M77">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@type]" priority="1000" mode="M78">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@base]" priority="1000" mode="M79">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@itemType]" priority="1000" mode="M80">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@memberTypes]" priority="1000" mode="M81">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@ref]" priority="1000" mode="M82">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@substitutionGroup]" priority="1000" mode="M83">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="xs:complexType[exists(xs:complexContent)                                    and not(ends-with(@name, 'AssociationType')                                        or ends-with(@name, 'MetadataType')                                        or ends-with(@name, 'AugmentationType'))]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="every $derivation-method in (xs:complexContent/xs:extension, xs:complexContent/xs:restriction), $base in $derivation-method/@base, $base-qname in resolve-QName($base, $derivation-method), $base-local-name in local-name-from-QName($base-qname) satisfies ( $base-qname = xs:QName('structures:ObjectType') or not(ends-with($base-local-name, 'AssociationType') or ends-with($base-local-name, 'AugmentationType')))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M94">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M95">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:element[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M106">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M107">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M108">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute" priority="1002" mode="M109">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M109">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="matches(@name, '^[A-Z]')"/>
   ...
   <!--RULE -->
   <xsl:template match="appinfo:LocalTerm" priority="1000" mode="M113">
   ...
   <!--RULE -->
   <xsl:template match="appinfo:LocalTerm" priority="1000" mode="M114">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="appinfo:LocalTerm"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M117">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@base)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:simpleType[@name]" priority="1000" mode="M118">
   ...
   <!--RULE -->
   <xsl:template match="xs:list[exists(@itemType)]" priority="1000" mode="M119">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="xs:union[exists(@memberTypes)]" priority="1000" mode="M120">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="xs:simpleType[exists(@name)      and (xs:restriction/xs:enumeration           or xs:restriction[ends-with(local-name-from-QName(resolve-QName(@base, .)), 'CodeSimpleType')])]"
      ...
      <xsl:if test="not(ends-with(@name, 'CodeSimpleType'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>A simple type definition schema component that has an enumeration facet or that is derived from a code simple type SHOULD have a name that ends in "CodeSimpleType".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M121"/>
   </xsl:template>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M124">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:element[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M125">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:element[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[@name]" priority="1000" mode="M126">
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M129">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@type)]"/>
      <xsl:variable name="namespace"
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M130">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@name)]"/>
      <!--REPORT warning-->
      <xsl:if test="every $representation-term              in ('Amount', 'BinaryObject', 'Graphic', 'Picture', 'Sound', 'Video', 'Code', 'DateTime', 'Date', 'Time', 'Duration', 'ID', 'URI', 'Indicator', 'Measure', 'Numeric', 'Value', 'Rate', 'Percent', 'Quantity', 'Text', 'Name', 'List')              satisfies not(ends-with(@name, $representation-term))">
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[@ref]" priority="1000" mode="M132">
   ...
   <!--RULE -->
   <xsl:template match="xs:attributeGroup[@ref]" priority="1000" mode="M133">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="xs:documentation" priority="1000" mode="M134">
   ...
   <!--RULE -->
   <xsl:template match="xs:import" priority="1000" mode="M154">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:import"/>
