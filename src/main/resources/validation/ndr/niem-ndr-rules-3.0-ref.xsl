...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="*[. is nf:get-document-element(.)]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 4-5: The document MUST have an effective conformance target identifier of http://reference.niem.gov/niem/specification/naming-and-design-rules/3.0/#ReferenceSchemaDocument.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:complexContent" priority="1000" mode="M45">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-29: An element xs:complexContent MUST have a child xs:extension.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:simpleContent" priority="1000" mode="M47">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-32: A complex type definition with simple content schema component MUST have a derivation method of extension.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:complexType" priority="1000" mode="M48">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-33: An element xs:complexType MUST NOT have an attribute {}block.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:complexType" priority="1000" mode="M49">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-34: An element xs:complexType MUST NOT have an attribute {}final.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:element" priority="1000" mode="M57">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-42: An element xs:element MUST NOT have an attribute {}block.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:element" priority="1000" mode="M58">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-43: An element xs:element MUST NOT have an attribute {}final.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:element[@name and (empty(@abstract)                                            or xs:boolean(@abstract) = false())]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-46: An element declaration MUST have the {nillable} property with a value of true.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:sequence" priority="1000" mode="M75">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-61: An element xs:sequence MUST be a child of element xs:extension.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:choice" priority="1000" mode="M76">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-63: The schema MUST NOT contain the element xs:choice</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:any" priority="1000" mode="M79">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-69: The schema MUST NOT contain the element xs:any.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:anyAttribute" priority="1000" mode="M80">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-70: The schema MUST NOT contain the element xs:anyAttribute.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:schema" priority="1000" mode="M95">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-85: An element xs:schema MUST NOT have an attribute {}blockDefault.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:schema" priority="1000" mode="M96">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 9-86: An element xs:schema MUST NOT have an attribute {}finalDefault.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:complexType[                        @name[not(ends-with(., 'MetadataType'))                              and not(ends-with(., 'AugmentationType'))]                        and empty(@appinfo:externalAdapterTypeIndicator)                        and xs:complexContent]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 10-21: An augmentable type MUST contain an element use of its augmentation point element.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:complexType//xs:element[exists(@ref[                            matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 10-27: An augmentation point element particle MUST have attribute minOccurs equal to 0.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="xs:complexType//xs:element[exists(@ref[                            matches(local-name-from-QName(resolve-QName(., ..)), 'AugmentationPoint$')]) ]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 10-28: An augmentation point element particle MUST have attribute maxOccurs set to unbounded.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="*[exists(@appinfo:externalAdapterTypeIndicator)]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message xmlns:iso="http://purl.oclc.org/dsdl/schematron">
               <xsl:text>Rule 10-69: The attribute appinfo:externalAdapterTypeIndicator MUST be owned by an element xs:complexType.</xsl:text>
            </xsl:message>
         </xsl:otherwise>
      </xsl:choose>
