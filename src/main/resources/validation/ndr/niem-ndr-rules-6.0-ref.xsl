...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule_4-8</xsl:attribute>
            <xsl:attribute name="name">Schema claims reference conformance target</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--PATTERN rule_4-8Schema claims reference conformance target-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schema claims reference conformance target</svrl:text>
   <!--RULE -->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 4-7: The document MUST have an effective conformance target identifier of https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#ReferenceSchemaDocument.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M10"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:enumeration" priority="1000" mode="M24">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(xs:extension)">
               ...
               <svrl:text>Rule 9-33: 
     A complex type definition with simple content schema component MUST have a derivation method of extension.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M42"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@block)">
               ...
               <svrl:text>Rule 9-34: 
     An element xs:complexType MUST NOT have an attribute {}block.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M43"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@final)">
               ...
               <svrl:text>Rule 9-35: 
     An element xs:complexType MUST NOT have an attribute {}final.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M44"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[@type]" priority="1000" mode="M50">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@block)">
               ...
               <svrl:text>Rule 9-43: 
     An element xs:element MUST NOT have an attribute {}block.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M51"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="empty(@final)">
               ...
               <svrl:text>Rule 9-44: 
     An element xs:element MUST NOT have an attribute {}final.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M52"/>
   ...
   <xsl:template match="xs:attribute[exists(@ref) and @use eq 'required']"
      ...
      <xsl:if test="false()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
            ...
            <svrl:text>This rule does not constrain attribute uses that are required</svrl:text>
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType[                       @name[not(ends-with(., 'MetadataType'))                             and not(ends-with(., 'AugmentationType'))                             and not(ends-with(., 'AdapterType'))]                       and xs:complexContent]"
                 priority="1000"
                 mode="M111">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:complexType[                       @name[not(ends-with(., 'MetadataType'))                             and not(ends-with(., 'AugmentationType'))                             and not(ends-with(., 'AdapterType'))]                       and xs:complexContent]"/>
   ...
   <xsl:template match="xs:element[exists(@name[                                 matches(., 'AugmentationPoint$')])]"
      ...
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="exists(                        parent::xs:schema/xs:complexType[                          @name = replace($element-name, 'AugmentationPoint$', 'Type')                          and exists(@name[                                  not(ends-with(., 'AugmentationType'))                                  and not(ends-with(., 'AdapterType'))])                                and exists(child::xs:complexContent)])"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="exists( parent::xs:schema/xs:complexType[ @name = replace($element-name, 'AugmentationPoint$', 'Type') and exists(@name[ not(ends-with(., 'AugmentationType')) and not(ends-with(., 'AdapterType'))]) and exists(child::xs:complexContent)])">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
   ...
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M148">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@name)]"/>
      <!--REPORT warning-->
      <xsl:if test="every $representation-term              in ('Amount', 'BinaryObject', 'Graphic', 'Picture', 'Sound', 'Video', 'Code', 'DateTime', 'Date', 'Time', 'Duration', 'ID', 'URI', 'Indicator', 'Measure', 'Numeric', 'Value', 'Rate', 'Percent', 'Quantity', 'Text', 'Name', 'List', 'Ref')              satisfies not(ends-with(@name, $representation-term))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                 test="every $representation-term in ('Amount', 'BinaryObject', 'Graphic', 'Picture', 'Sound', 'Video', 'Code', 'DateTime', 'Date', 'Time', 'Duration', 'ID', 'URI', 'Indicator', 'Measure', 'Numeric', 'Value', 'Rate', 'Percent', 'Quantity', 'Text', 'Name', 'List', 'Ref') satisfies not(ends-with(@name, $representation-term))">
            <xsl:attribute name="role">warning</xsl:attribute>
            <xsl:attribute name="location">
               <xsl:apply-templates select="." mode="schematron-select-full-path"/>
            </xsl:attribute>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(ancestor::xs:complexType[@name[not(ends-with(., 'AdapterType'))]]) and @ref]"
                 priority="1000"
                 mode="M149">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:element[exists(ancestor::xs:complexType[@name[not(ends-with(., 'AdapterType'))]]) and @ref]"/>
      <xsl:variable name="namespace"
