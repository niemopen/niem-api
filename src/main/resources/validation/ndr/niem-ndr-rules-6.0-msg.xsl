...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                              title="Rules for message XML Schema documents"
                              schemaVersion="">
         <xsl:comment>
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="id">rule_4-10</xsl:attribute>
            <xsl:attribute name="name">Schema claims message conformance target</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
   ...
   <!--SCHEMATRON PATTERNS-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Rules for message XML Schema documents</svrl:text>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 4-6: The [document element] of the XML document, and only the [document element], MUST own an attribute {https://docs.oasis-open.org/niemopen/ns/specification/conformanceTargets/6.0/}conformanceTargets.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M9"/>
   ...
   <!--PATTERN rule_4-10Schema claims message conformance target-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Schema claims message conformance target</svrl:text>
   <!--RULE -->
   <xsl:template match="*[. is nf:get-document-element(.)]"
      ...
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#MessageSchemaDocument'))"/>
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="nf:has-effective-conformance-target-identifier(., xs:anyURI('https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#MessageSchemaDocument'))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 4-10: The document MUST have an effective conformance target identifier of https://docs.oasis-open.org/niemopen/ns/specification/NDR/6.0/#MessageSchemaDocument.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M10"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:enumeration" priority="1000" mode="M21">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@itemType)]" priority="1000" mode="M22">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@memberTypes)]" priority="1000" mode="M26">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M32">
   ...
   <!--RULE -->
   <xsl:template match="xs:complexType[exists(@mixed)]" priority="1000" mode="M33">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-31: 
    The base type of complex type that has complex content MUST be a complex type with complex content.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M36"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M37">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-36: 
     An element declaration MUST be top-level.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M37"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M38">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:element[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-37: 
     An element declaration MUST have a data definition.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M38"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-38: 
     A top-level element declaration that does not set the {type definition} property via the attribute "type" MUST have the {abstract} property with a value of "true".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M39"/>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-39: 
               An element declaration that has a type xs:anySimpleType MUST have the {abstract} property with a value of "true".</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M40"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M41">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-41: 
     An element type MUST NOT have a namespace name that is in the XML namespace.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M41"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M42">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M43">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M44">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M45">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M46">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M47">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M48">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M49">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:notation" priority="1000" mode="M51">
   ...
   <!--RULE -->
   <xsl:template match="xs:all" priority="1000" mode="M52">
   ...
   <!--RULE -->
   <xsl:template match="xs:sequence" priority="1000" mode="M53">
   ...
   <!--RULE -->
   <xsl:template match="xs:choice" priority="1000" mode="M54">
   ...
   <!--RULE -->
   <xsl:template match="xs:sequence" priority="1000" mode="M55">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:sequence"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:sequence" priority="1000" mode="M56">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:sequence"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:choice" priority="1000" mode="M57">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:choice"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:choice" priority="1000" mode="M58">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:choice"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="empty(@maxOccurs) or (@maxOccurs instance of xs:integer                                            and 1 = xs:integer(@maxOccurs))"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:unique" priority="1000" mode="M59">
   ...
   <!--RULE -->
   <xsl:template match="xs:key" priority="1000" mode="M60">
   ...
   <!--RULE -->
   <xsl:template match="xs:keyref" priority="1000" mode="M61">
   ...
   <!--RULE -->
   <xsl:template match="xs:group" priority="1000" mode="M62">
   ...
   <!--RULE -->
   <xsl:template match="xs:attributeGroup[@name]" priority="1000" mode="M63">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="node()[comment()]" priority="1000" mode="M64">
      ...
      <xsl:if test="true()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="true()">
            ...
            <svrl:text>An XML Comment is not an XML Schema annotation component; an XML comment SHOULD NOT appear in the schema.</svrl:text>
   ...
   <!--RULE -->
   <xsl:template match="xs:documentation/node()" priority="1000" mode="M65">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="xs:appinfo/node()" priority="1000" mode="M66">
   ...
   <!--RULE -->
   <xsl:template match="xs:appinfo/*" priority="1000" mode="M67">
   ...
   <!--RULE -->
   <xsl:template match="xs:appinfo//xs:*" priority="1000" mode="M68">
   ...
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M69">
   ...
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M70">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:schema" priority="1000" mode="M71">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:schema"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:redefine" priority="1000" mode="M72">
   ...
   <!--RULE -->
   <xsl:template match="xs:include" priority="1000" mode="M73">
   ...
   <!--RULE -->
   <xsl:template match="xs:import" priority="1000" mode="M74">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@type]" priority="1000" mode="M75">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@base]" priority="1000" mode="M76">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@itemType]" priority="1000" mode="M77">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@memberTypes]" priority="1000" mode="M78">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@ref]" priority="1000" mode="M79">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[@substitutionGroup]" priority="1000" mode="M80">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="xs:complexType[exists(xs:simpleContent[                       exists(xs:*[local-name() = ('extension', 'restriction')                                   and (ends-with(@base, 'CodeSimpleType')                                   or ends-with(@base, 'CodeType'))])])]"
      ...
      <xsl:if test="not(ends-with(@name, 'CodeType'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>A complex type definition with a {base type definition} of a code type or code simple type SHOULD have a {name} that ends in 'CodeType'.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M87"/>
   </xsl:template>
   ...
   <xsl:template match="xs:element[exists(@name) and exists(@type) and ends-with(@type, 'CodeType')]"
      ...
      <xsl:if test="not(ends-with(@name, 'Code'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>An element with a type that is a code type SHOULD have a name with representation term "Code"</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M88"/>
   </xsl:template>
   ...
   <xsl:template match="xs:element[@name[ends-with(., 'Representation')]]"
      ...
      <xsl:if test="empty(@abstract) or xs:boolean(@abstract) = false()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>An element declaration with a name that ends in 'Representation' SHOULD have the {abstract} property with a value of "true".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M98"/>
   </xsl:template>
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M99">
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M100">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M101">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute" priority="1002" mode="M102">
      ...
      <xsl:if test="false()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
            ...
            <svrl:text>This rule does not apply to an attribute.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M102"/>
   </xsl:template>
   ...
   <xsl:template match="xs:complexType[some $name in @name,                                    $extension in xs:simpleContent/xs:extension,                                    $base-qname in resolve-QName($extension/@base, $extension) satisfies                                    $base-qname = QName('http://www.w3.org/2001/XMLSchema', $name)]"
      ...
      <xsl:if test="false()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
            ...
            <svrl:text>This rule does not apply to a proxy types.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M102"/>
   </xsl:template>
   <!--RULE -->
   <xsl:template match="xs:*[exists(@name)]" priority="1000" mode="M102">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@name)]"/>
      <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="matches(@name, '^[A-Z]')"/>
   ...
   <!--RULE -->
   <xsl:template match="*[exists(@appinfo:deprecated)]" priority="1000" mode="M103">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="exists(self::xs:import)">
               ...
               <svrl:text>Rule 10-70: The attribute {https://docs.oasis-open.org/niemopen/ns/model/appinfo/6.0/}externalImportIndicator MUST be owned by an element xs:import.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M104"/>
   ...
   <!--RULE -->
   <xsl:template match="appinfo:LocalTerm" priority="1000" mode="M106">
   ...
   <!--RULE -->
   <xsl:template match="appinfo:LocalTerm" priority="1000" mode="M107">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="appinfo:LocalTerm"/>
      <!--ASSERT -->
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 10-77: The element {https://docs.oasis-open.org/niemopen/ns/model/appinfo/6.0/}LocalTerm MUST have a literal or definition.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M107"/>
   ...
   <xsl:template match="xs:complexType[some $name in @name,                                    $extension in xs:simpleContent/xs:extension,                                    $base-qname in resolve-QName($extension/@base, $extension) satisfies                                    $base-qname = QName('http://www.w3.org/2001/XMLSchema', $name)]"
      ...
      <xsl:if test="false()">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl" test="false()">
            ...
            <svrl:text>The name of a proxy type does not end in "Type".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M108"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>A schema component with a name that ends in 'Type' and does not end in 'SimpleType' MUST be a complex type definition.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M109"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M110">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@base)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:simpleType[@name]" priority="1000" mode="M111">
   ...
   <!--RULE -->
   <xsl:template match="xs:list[exists(@itemType)]" priority="1000" mode="M112">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <!--RULE -->
   <xsl:template match="xs:union[exists(@memberTypes)]" priority="1000" mode="M113">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
   ...
   <xsl:template match="xs:attribute[exists(@name) and exists(@type) and ends-with(@type, 'CodeSimpleType')]"
      ...
      <xsl:if test="not(ends-with(@name, 'Code'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>An attribute with a type that is a code simple type SHOULD have a name with representation term "Code"</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M114"/>
   </xsl:template>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M115">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:element[exists(@type)]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:element[@name]" priority="1000" mode="M117">
      ...
      <xsl:if test="not(exists(@abstract[xs:boolean(.) = true()])                  eq (ends-with(@name, 'Abstract')                      or ends-with(@name, 'AugmentationPoint')                      or ends-with(@name, 'Representation')))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>An element declaration SHOULD have a name that ends in 'Abstract', 'AugmentationPoint', or 'Representation' if and only if it has the {abstract} property with a value of "true".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M117"/>
   </xsl:template>
   ...
   <xsl:template match="xs:element[@name and @type                                and (some $type-qname in resolve-QName(@type, .) satisfies (                                       nf:get-target-namespace(.) = namespace-uri-from-QName($type-qname)                                       and nf:resolve-type(., $type-qname)/xs:simpleContent))]"
      ...
      <xsl:if test="every $representation-term              in ('Amount', 'BinaryObject', 'Graphic', 'Picture', 'Sound', 'Video', 'Code', 'DateTime', 'Date', 'Time', 'Duration', 'ID', 'URI', 'Indicator', 'Measure', 'Numeric', 'Value', 'Rate', 'Percent', 'Quantity', 'Text', 'Name', 'List')              satisfies not(ends-with(@name, $representation-term))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The name of an element declaration that is of simple content SHOULD use a representation term.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M118"/>
   </xsl:template>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M121">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@name)]"/>
      <!--REPORT warning-->
      <xsl:if test="every $representation-term              in ('Amount', 'BinaryObject', 'Graphic', 'Picture', 'Sound', 'Video', 'Code', 'DateTime', 'Date', 'Time', 'Duration', 'ID', 'URI', 'Indicator', 'Measure', 'Numeric', 'Value', 'Rate', 'Percent', 'Quantity', 'Text', 'Name', 'List')              satisfies not(ends-with(@name, $representation-term))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>An attribute name SHOULD end with a representation term.</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M121"/>
   </xsl:template>
   ...
   <!--RULE -->
   <xsl:template match="xs:attribute[@ref]" priority="1000" mode="M123">
   ...
   <!--RULE -->
   <xsl:template match="xs:attributeGroup[@ref]" priority="1000" mode="M124">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                                test="some $ref in resolve-QName(@ref, .) satisfies ( $ref = xs:QName('structures:SimpleObjectAttributeGroup'))">
               <xsl:attribute name="location">
                  <xsl:apply-templates select="." mode="schematron-select-full-path"/>
               </xsl:attribute>
               <svrl:text>Rule 11-23: An attribute group reference MUST be structures:SimpleObjectAttributeGroup</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M124"/>
   ...
   <!--RULE -->
   <xsl:template match="xs:documentation" priority="1000" mode="M125">
   ...
   <xsl:template match="xs:element[ends-with(@name, 'AugmentationPoint')]/xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(starts-with(lower-case(normalize-space(.)), 'an augmentation point '))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an augmentation point element SHOULD begin with standard opening phrase "An augmentation point...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M126"/>
   </xsl:template>
   ...
   <xsl:template match="xs:element[ends-with(@name, 'Augmentation')]/xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="every $phrase              in ('supplements ', 'additional information about ')              satisfies not(starts-with(lower-case(normalize-space(.)), $phrase))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an augmentation element SHOULD begin with the standard opening phrase "Supplements..." or "Additional information about...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M127"/>
   </xsl:template>
   ...
   <xsl:template match="xs:element[ends-with(@name, 'Metadata')                                and not(xs:boolean(@abstract) eq true())]/xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '(metadata about|information that further qualifies)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for a metadata element SHOULD begin with the standard opening phrase "Metadata about..." or "Information that further qualifies...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M128"/>
   </xsl:template>
   ...
   <xsl:template match="xs:element[ends-with(@name, 'Association')                                and not(xs:boolean(@abstract) eq true())]/xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (relationship|association)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an association element that is not abstract SHOULD begin with the standard opening phrase "An (optional adjectives) (relationship|association)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M129"/>
   </xsl:template>
   ...
   <xsl:template match="xs:element[xs:boolean(@abstract) = true()                       and not(ends-with(@name, 'AugmentationPoint'))]/xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(starts-with(lower-case(normalize-space(.)), 'a data concept'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an abstract element SHOULD begin with the standard opening phrase "A data concept...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M130"/>
   </xsl:template>
   ...
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                       and ends-with(@name, 'Date') and not(xs:boolean(@abstract) eq true())]                      /xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (date|month|year)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an element or attribute with a date representation term SHOULD begin with the standard opening phrase "(A|An) (optional adjectives) (date|month|year)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M131"/>
   </xsl:template>
   ...
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                       and ends-with(@name, 'Quantity') and not(xs:boolean(@abstract) eq true())]                      /xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (count|number)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an element or attribute with a quantity representation term SHOULD begin with the standard opening phrase "An (optional adjectives) (count|number)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M132"/>
   </xsl:template>
   ...
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                       and ends-with(@name, 'Picture') and not(xs:boolean(@abstract) eq true())]                      /xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (image|picture|photograph)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an element or attribute with a picture representation term SHOULD begin with the standard opening phrase "An (optional adjectives) (image|picture|photograph)".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M133"/>
   </xsl:template>
   ...
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                       and ends-with(@name, 'Indicator') and not(xs:boolean(@abstract) eq true())]                      /xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^true if .*; false (otherwise|if)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an element or attribute with an indicator representation term SHOULD begin with the standard opening phrase "True if ...; false (otherwise|if)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M134"/>
   </xsl:template>
   ...
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                       and ends-with(@name, 'Identification') and not(xs:boolean(@abstract) eq true())]                      /xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? identification'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an element or attribute with an identification representation term SHOULD begin with the standard opening phrase "(A|An) (optional adjectives) identification...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M135"/>
   </xsl:template>
   ...
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                       and ends-with(@name, 'Name') and not(xs:boolean(@abstract) eq true())]                      /xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^(a|an)( .*)? name'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an element or attribute with a name representation term SHOULD begin with the standard opening phrase "(A|An) (optional adjectives) name...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M136"/>
   </xsl:template>
   ...
   <xsl:template match="*[(self::xs:element or self::xs:attribute)                       and @name                       and not(ends-with(@name, 'Indicator'))                       and not(ends-with(@name, 'Augmentation'))                       and not(ends-with(@name, 'Metadata'))                       and not(xs:boolean(@abstract) eq true())]                      /xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an? '))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an element or attribute declaration SHOULD begin with the standard opening phrase "(A|An)".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M137"/>
   </xsl:template>
   ...
   <xsl:template match="xs:complexType[ends-with(@name, 'AssociationType')]/xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^a data type for (a relationship|an association)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an association type SHOULD begin with the standard opening phrase "A data type for (a relationship|an association)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M138"/>
   </xsl:template>
   ...
   <xsl:template match="xs:complexType[ends-with(@name, 'AugmentationType')]/xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)),                          '^a data type (that supplements|for additional information about)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for an augmentation type SHOULD begin with the standard opening phrase "A data type (that supplements|for additional information about)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M139"/>
   </xsl:template>
   ...
   <xsl:template match="xs:complexType[ends-with(@name, 'MetadataType')]/xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)),                          '^a data type for (metadata about|information that further qualifies)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for a metadata type SHOULD begin with the standard opening phrase "A data type for (metadata about|information that further qualifies)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M140"/>
   </xsl:template>
   ...
   <xsl:template match="xs:complexType/xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^a data type'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for a complex type SHOULD begin with the standard opening phrase "A data type...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M141"/>
   </xsl:template>
   ...
   <xsl:template match="xs:simpleType/xs:annotation/xs:documentation[1]"
      ...
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^a data type'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>The data definition for a simple type SHOULD begin with a standard opening phrase "A data type...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M142"/>
   </xsl:template>
   ...
   <xsl:template match="xs:import[exists(@namespace)                            and xs:anyURI(@namespace) = xs:anyURI(                    'https://docs.oasis-open.org/niemopen/ns/model/structures/6.0/')]"
                 ...
                 mode="M143">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:import[exists(@namespace)                            and xs:anyURI(@namespace) = xs:anyURI(                    'https://docs.oasis-open.org/niemopen/ns/model/structures/6.0/')]"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="xs:import" priority="1000" mode="M145">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:import"/>
