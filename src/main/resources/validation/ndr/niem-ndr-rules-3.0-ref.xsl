...
<xsl:stylesheet xmlns:xs="http://www.w3.org/2001/XMLSchema"
   ...
   <xsl:template match="/">
      <svrl:schematron-output xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
         ...
         <svrl:active-pattern>
            ...
            <xsl:attribute name="name">Association types is derived from association type</xsl:attribute>
            <xsl:apply-templates/>
         </svrl:active-pattern>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 9-39: An element type that is not xs:anySimpleType MUST NOT have a namespace name .</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M50"/>
  ...
  <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M111">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
  ...
  <!--PATTERN rule_10-19Association types is derived from association type-->
   <svrl:text xmlns:svrl="http://purl.oclc.org/dsdl/svrl">Association types is derived from association type</svrl:text>
  <!--RULE -->
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 10-19: A type MUST have a association type name if and only if it is derived from an association type.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M113"/>
  ...
  <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M126">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:element[exists(@name)]"/>
    <!--ASSERT -->
      <xsl:choose>
  ...
  <!--RULE -->
   <xsl:template match="xs:complexType" priority="1000" mode="M127">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:complexType"/>
  ...
  <!--RULE -->
   <xsl:template match="*[exists(@appinfo:deprecated)]" priority="1000" mode="M130">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 10-67: The attribute appinfo:deprecated MUST be owned by an element with a namespace name .</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M130"/>
  ...
  <!--RULE -->
   <xsl:template match="term:LocalTerm" priority="1000" mode="M135">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 10-74: The element term:LocalTerm MUST be application information an an element xs:schema.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M135"/>
  ...
  <!--RULE -->
   <xsl:template match="term:LocalTerm" priority="1000" mode="M136">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="term:LocalTerm"/>
    <!--ASSERT -->
      <xsl:choose>
  ...
  <!--RULE -->
   <xsl:template match="xs:*[exists(@base)]" priority="1000" mode="M139">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl" context="xs:*[exists(@base)]"/>
    <!--ASSERT -->
      <xsl:choose>
  ...
  <!--RULE -->
   <xsl:template match="xs:simpleType[@name]" priority="1000" mode="M140">
  ...
  <!--RULE -->
   <xsl:template match="xs:simpleType[exists(@name)]" priority="1000" mode="M141">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
  ...
  <!--RULE -->
   <xsl:template match="xs:list[exists(@itemType)]" priority="1000" mode="M142">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
  ...
  <!--RULE -->
   <xsl:template match="xs:union[exists(@memberTypes)]" priority="1000" mode="M143">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
  ...
  <!--RULE -->
   <xsl:template match="xs:element[exists(@name)]" priority="1000" mode="M147">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:element[exists(@name)]"/>
    <!--ASSERT -->
      <xsl:choose>
  ...
  <!--RULE -->
   <xsl:template match="xs:element[exists(@type)]" priority="1000" mode="M148">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:element[exists(@type)]"/>
    <!--ASSERT -->
      <xsl:choose>
  ...
  <!--RULE -->
   <xsl:template match="xs:attribute[exists(@type)]" priority="1000" mode="M153">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@type)]"/>
      <xsl:variable name="namespace"
  ...
  <!--RULE -->
   <xsl:template match="xs:attribute[exists(@name)]" priority="1000" mode="M154">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
                       context="xs:attribute[exists(@name)]"/>
    <!--ASSERT -->
      <xsl:choose>
  ...
  <!--RULE -->
   <xsl:template match="xs:attribute[@ref]" priority="1000" mode="M156">
  ...
  <!--RULE -->
   <xsl:template match="xs:attributeGroup[@ref]" priority="1000" mode="M157">
      <svrl:fired-rule xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
    ...
    <!--REPORT -->
      <xsl:if test="not(matches(lower-case(normalize-space(.)),                                   '^an?( .*)? (relationship|association)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Rule 11-31: The data defintion for an association element that is not abstract SHOULD begin with the standard opening phrase "an (optional adjectives) (relationship|association)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M158"/>
   </xsl:template>
    ...
    <!--REPORT -->
      <xsl:if test="not(starts-with(lower-case(normalize-space(.)), 'a data concept'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Rule 11-31: The data defintion for an abstract element SHOULD begin with the standard opening phrase "a data concept...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M158"/>
   </xsl:template>
    ...
    <!--REPORT -->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (date|month|year)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Rule 11-31: The data defintion for an element with a date representation term SHOULD begin with the standard opening phrase "a(n?) (optional adjectives) (date|month|year)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M158"/>
   </xsl:template>
    ...
    <!--REPORT -->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (count|number)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Rule 11-31: The data defintion for an element with a quantity representation term SHOULD begin with the standard opening phrase "an (optional adjectives) (count|number)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M158"/>
   </xsl:template>
    ...
    <!--REPORT -->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? (image|picture|photograph)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Rule 11-31: The data defintion for an element with a picture representation term SHOULD begin with the standard opening phrase "an (optional adjectives) (image|picture|photograph)".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M158"/>
   </xsl:template>
    ...
    <!--REPORT -->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^true if .*; false (otherwise|if)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Rule 11-31: The data defintion for an element with an indicator representation term SHOULD begin with the standard opening phrase "true if ...; false (otherwise|if)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M158"/>
   </xsl:template>
    ...
    <!--REPORT -->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an?( .*)? identification'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Rule 11-31: The data defintion for an element with an identification representation term SHOULD begin with the standard opening phrase "(a|an) (optional adjectives) identification...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M158"/>
   </xsl:template>
    ...
    <!--REPORT -->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^(a|an)( .*)? name'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Rule 11-31: The data defintion for an element with a name representation term SHOULD begin with the standard opening phrase "(a|an) (optional adjectives) name...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M158"/>
   </xsl:template>
    ...
    <!--REPORT -->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^an? '))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Rule 11-31: The data defintion for an element declaration with a name SHOULD begin with the standard opening phrase "(a|an)".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M158"/>
   </xsl:template>
    ...
    <!--REPORT -->
      <xsl:if test="not(matches(lower-case(normalize-space(.)), '^a data type for (metadata about|information that further qualifies)'))">
         <svrl:successful-report xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
            ...
            <svrl:text>Rule 11-32: The data definition for a metadata type SHOULD begin with the standard opening phrase "a data type for (metdata about|information that further qualifies)...".</svrl:text>
         </svrl:successful-report>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M159"/>
   </xsl:template>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <svrl:failed-assert xmlns:svrl="http://purl.oclc.org/dsdl/svrl"
               ...
               <svrl:text>Rule 11-39: An import of the XML namespace MUST NOT be labeld as an external import.</svrl:text>
            </svrl:failed-assert>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M162"/>
